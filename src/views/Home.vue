	...
	<div class="from-slate-50 bg-slate-100 w-screen h-screen overflow-auto">
		...
		>
			...
			/><button
				...
				class="bg-purple-400 from-purple-500 bg-gradient-to-br hover:bg-purple-600 hover:from-purple-600 transition-shadow hover:drop-shadow-lg drop-shadow p-3 rounded text-white mt-24"
			>
				Send to See Travel ⇾
			</button>
		</div>
